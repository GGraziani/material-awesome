...
local rofi_switch_command = 'env /usr/bin/rofi -dpi ' .. get_dpi() .. ' -width ' .. with_dpi(400) .. ' -combi-modi window -show combi -theme ' .. filesystem.get_configuration_dir() .. '/configuration/rofi.rasi -run-command "/bin/bash -c -i \'shopt -s expand_aliases; {cmd}\'"'

-- $mod+Tab exec --no-startup-id rofi -disable-history -combi-modi window -show combi -show-icons
return {
